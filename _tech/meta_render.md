...
1. After you create your sequence, add it to your render queue using the output settings that you normally would. Note your sequence's name and your project file's name and close the program.
...
3. Now you are able to run the `aerender` process in the command line
